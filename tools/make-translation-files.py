...
rows += [
    ...
    {'key': 'cfg.coupleName', 'where': 'invitation, closing', 'source': 'index.html',
     'en': 'Gohar &amp; Roman'},
    {'key': 'wishes.label', 'where': 'hero ticker', 'source': 'site.js (screen readers)',
     'en': 'Wishes from our guests'},
    {'key': 'wish.placeholder', 'where': 'hero ticker', 'source': 'site.js (field hint)',
     'en': 'Leave a wish…'},
    {'key': 'wish.name', 'where': 'hero ticker', 'source': 'site.js (field hint)',
     'en': 'Your name'},
    {'key': 'wish.send', 'where': 'hero ticker', 'source': 'site.js (button)',
     'en': 'Send a wish'},
    {'key': 'wish.sending', 'where': 'hero ticker', 'source': 'site.js',
     'en': 'Sending…'},
    {'key': 'wish.thanks', 'where': 'hero ticker', 'source': 'site.js',
     'en': 'Thank you! ♥'},
    {'key': 'wish.error', 'where': 'hero ticker', 'source': 'site.js',
     'en': 'Could not send. Please try again.'},
    {'key': 'wish.someone', 'where': 'hero ticker', 'source': 'site.js (no name given)',
     'en': 'A guest'},
